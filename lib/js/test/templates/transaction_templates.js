...
export async function submitBothSingleplayerMovesPasses(account, matchID, move) {
    await shallPass(
        sendTransaction(
...
export async function submitBothSingleplayerMovesReverts(account, matchID, move) {
    await shallRevert(
        sendTransaction(
            "rock_paper_scissors_game/game_player/submit_both_singleplayer_moves",
            [account],
