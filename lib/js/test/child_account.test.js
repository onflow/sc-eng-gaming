...
describe("child_accounts", ()=>{
  ...
  // First test checks if service account can create a parent-less child account 
  test("Admin should be able to create a child account", async () => {
    // First step: create a child account
    await shallPass(
      sendTransaction({
  ...
  // Second test checks if parent account can create a child for itself
  test("Parent should be able to create child account for itself", async () => {
    // First step: create a child account manager
    await shallPass(
      sendTransaction({
        name: "child_account/create_child_account_manager",
        args: [],
    ...
    // Third step: associate child account
    await shallPass(
      sendTransaction({
        name: "child_account/add_as_child_account",
        args: [],
        signers: []
      })
    );
  ...
  // Third test checks if service account can delegate a child to a parent
  ...
  // Fourth test checks if parent can access child account
