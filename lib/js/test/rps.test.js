...
describe("rockpaperscissorsgame", ()=>{
  ...
  // Seventh test checks if a player is able to submit auto player moves to the match it is playing
  ...
  // Eight test checks two players can complete a Match, and that the autoplayer method can not be used for cheating
